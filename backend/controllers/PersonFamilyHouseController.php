...
use backend\models\search\PersonFamilyHouseSearch;
...
/**
 * PersonFamilyHouseController implements the CRUD actions for PersonFamilyHouse model.
 */
class PersonFamilyHouseController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\PersonFamilyHouse',
                        'searchModelClass' => 'backend\models\search\PersonFamilyHouseSearch'            ],
            'access' => [
...
//            ],
    ...
    {
        return $this->module->getViewPath() . DIRECTORY_SEPARATOR . 'customer/person-family-house';
    }
    ...
    public function actionCreate($id)
    {
        ...
        $model = new PersonFamilyHouse();
        $model->customer_id = $id;

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->setFlash('success', Yii::t('backend', '增加成功！'));
            return $this->redirect(['customer/family-house-list', 'id' =>$id]);
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->redirect(['customer/family-house-list', 'id' =>$customer_id]);
        }
    ...
    /**
     * Finds the PersonFamilyHouse model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return PersonFamilyHouse the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = PersonFamilyHouse::findOne($id)) !== null) {
            return $model;
        } else {
