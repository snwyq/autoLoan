...
use backend\models\search\PersonFamilyCarSearch;
...
/**
 * PersonFamilyCarController implements the CRUD actions for PersonFamilyCar model.
 */
class PersonFamilyCarController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\PersonFamilyCar',
                        'searchModelClass' => 'backend\models\search\PersonFamilyCarSearch'            ],
            'access' => [
...
//            ],
    ...
    {
        return $this->module->getViewPath() . DIRECTORY_SEPARATOR . 'customer/person-family-car';
    }
    ...
    public function actionCreate($id)
    {
        ...
        $model = new PersonFamilyCar();
        $model->customer_id = $id;

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->setFlash('success', Yii::t('backend', '增加成功！'));
            return $this->redirect(['customer/family-car-list', 'id' =>$id]);
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->redirect(['customer/family-car-list', 'id' =>$customer_id]);
        }
    ...
    /**
     * Finds the PersonFamilyCar model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return PersonFamilyCar the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = PersonFamilyCar::findOne($id)) !== null) {
            return $model;
        } else {
