...
use backend\models\search\ProductClassSearch;
...
class ProductClassController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\ProductClass',
                        'searchModelClass' => 'backend\models\search\ProductClassSearch'            ],
            'access' => [
    ...
    {
        if (($model = ProductClass::findOne($id)) !== null) {
            return $model;
        } else {
