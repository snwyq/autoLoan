...
use backend\models\search\PersonProfileSearch;
...
/**
 * PersonProfileController implements the CRUD actions for PersonProfile model.
 */
class PersonProfileController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\PersonProfile',
                        'searchModelClass' => 'backend\models\search\PersonProfileSearch'            ],
            'access' => [
    ...
    /**
     * Finds the PersonProfile model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return PersonProfile the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = PersonProfile::findOne($id)) !== null) {
            return $model;
        } else {
