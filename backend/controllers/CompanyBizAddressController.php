...
use backend\models\search\CompanyBizAddressSearch;
...
/**
 * CompanyBizAddressController implements the CRUD actions for CompanyBizAddress model.
 */
class CompanyBizAddressController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\CompanyBizAddress',
                        'searchModelClass' => 'backend\models\search\CompanyBizAddressSearch'            ],
            'access' => [
...
//            ],
    ...
    {
        return $this->module->getViewPath() . DIRECTORY_SEPARATOR . 'customer/company-biz-address';
    }
    ...
    public function actionCreate($id)
    {
        ...
        $model = new CompanyBizAddress();
        $model->customer_id = $id;

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->setFlash('success', Yii::t('backend', '增加成功！'));
            return $this->redirect(['customer/biz-address-list', 'id' =>$id]);
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->redirect(['customer/biz-address-list', 'id' =>$customer_id]);
        }
    ...
    /**
     * Finds the CompanyBizAddress model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CompanyBizAddress the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = CompanyBizAddress::findOne($id)) !== null) {
            return $model;
        } else {
