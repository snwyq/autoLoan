...
use backend\models\search\CompanyTradeConditionSearch;
...
/**
 * CompanyTradeConditionController implements the CRUD actions for CompanyTradeCondition model.
 */
class CompanyTradeConditionController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\CompanyTradeCondition',
                        'searchModelClass' => 'backend\models\search\CompanyTradeConditionSearch'            ],
            'access' => [
...
//            ],
    ...
    {
        return $this->module->getViewPath() . DIRECTORY_SEPARATOR . 'customer/company-trade-condition';
    }
    ...
    public function actionCreate($id)
    {
        ...
        $model = new CompanyTradeCondition();
        $model->customer_id = $id;

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->setFlash('success', Yii::t('backend', '增加成功！'));
            return $this->redirect(['customer/trade-condition-list', 'id' =>$id]);
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->redirect(['customer/trade-condition-list', 'id' =>$customer_id]);
        }
    ...
    /**
     * Finds the CompanyTradeCondition model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CompanyTradeCondition the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = CompanyTradeCondition::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    {
    return new CompanyTradeCondition();
    }
