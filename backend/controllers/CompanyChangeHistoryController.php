...
use backend\models\search\CompanyChangeHistorySearch;
...
/**
 * CompanyChangeHistoryController implements the CRUD actions for CompanyChangeHistory model.
 */
class CompanyChangeHistoryController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\CompanyChangeHistory',
                        'searchModelClass' => 'backend\models\search\CompanyChangeHistorySearch'            ],
            'access' => [
...
//            ],
    ...
    {
        return $this->module->getViewPath() . DIRECTORY_SEPARATOR . 'customer/company-change-history';
    }
    ...
    public function actionCreate($id)
    {
        ...
        $model = new CompanyChangeHistory();
        $model->customer_id = $id;

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->setFlash('success', Yii::t('backend', '增加成功！'));
            return $this->redirect(['customer/change-history-list', 'id' =>$id]);
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->redirect(['customer/change-history-list', 'id' =>$customer_id]);
        }
    ...
    /**
     * Finds the CompanyChangeHistory model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CompanyChangeHistory the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = CompanyChangeHistory::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    {
    return new CompanyChangeHistory();
    }
