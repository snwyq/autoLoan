...
use backend\models\search\LoanMakeloansSearch;
...
/**
 * LoanMakeloansController implements the CRUD actions for LoanMakeloans model.
 */
class LoanMakeloansController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\LoanMakeloans',
                        'searchModelClass' => 'backend\models\search\LoanMakeloansSearch'            ],
            'access' => [
    ...
    /**
     * Finds the LoanMakeloans model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return LoanMakeloans the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = LoanMakeloans::findOne($id)) !== null) {
            return $model;
        } else {
