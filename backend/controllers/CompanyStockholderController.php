...
use backend\models\search\CompanyStockholderSearch;
...
/**
 * CompanyStockholderController implements the CRUD actions for CompanyStockholder model.
 */
class CompanyStockholderController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\CompanyStockholder',
                        'searchModelClass' => 'backend\models\search\CompanyStockholderSearch'            ],
            'access' => [
...
//            ],
    ...
    {
        return $this->module->getViewPath() . DIRECTORY_SEPARATOR . 'customer/company-stockholder';
    }
    ...
    public function actionCreate($id)
    {
        ...
        $model = new CompanyStockholder();
        $model->customer_id = $id;

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->setFlash('success', Yii::t('backend', '增加成功！'));
            return $this->redirect(['customer/stockholder-list', 'id' =>$id]);
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->redirect(['customer/stockholder-list', 'id' =>$customer_id]);
        }
    ...
    /**
     * Finds the CompanyStockholder model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CompanyStockholder the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = CompanyStockholder::findOne($id)) !== null) {
            return $model;
        } else {
