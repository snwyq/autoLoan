...
use backend\models\search\CompanyRelationCompanySearch;
...
/**
 * CompanyRelationCompanyController implements the CRUD actions for CompanyRelationCompany model.
 */
class CompanyRelationCompanyController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\CompanyRelationCompany',
                        'searchModelClass' => 'backend\models\search\CompanyRelationCompanySearch'            ],
            'access' => [
...
//            ],
    ...
    {
        return $this->module->getViewPath() . DIRECTORY_SEPARATOR . 'customer/company-relation-company';
    }
    ...
    public function actionCreate($id)
    {
        ...
        $model = new CompanyRelationCompany();
        $model->customer_id = $id;

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->setFlash('success', Yii::t('backend', '增加成功！'));
            return $this->redirect(['customer/relation-company-list', 'id' =>$id]);
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->redirect(['customer/relation-company-list', 'id' =>$customer_id]);
        }
    ...
    /**
     * Finds the CompanyRelationCompany model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CompanyRelationCompany the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = CompanyRelationCompany::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    {
    return new CompanyRelationCompany();
    }
