...
use backend\models\search\PersonFamilyPaySearch;
...
/**
 * PersonFamilyPayController implements the CRUD actions for PersonFamilyPay model.
 */
class PersonFamilyPayController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\PersonFamilyPay',
                        'searchModelClass' => 'backend\models\search\PersonFamilyPaySearch'            ],
            'access' => [
...
//            ],
    ...
    {
        return $this->module->getViewPath() . DIRECTORY_SEPARATOR . 'customer/person-family-pay';
    }
    ...
    public function actionCreate($id)
    {
        ...
        $model = new PersonFamilyPay();
        $model->customer_id = $id;

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->setFlash('success', Yii::t('backend', '增加成功！'));
            return $this->redirect(['customer/family-pay-list', 'id' =>$id]);
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->redirect(['customer/family-pay-list', 'id' =>$customer_id]);
        }
    ...
    /**
     * Finds the PersonFamilyPay model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return PersonFamilyPay the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = PersonFamilyPay::findOne($id)) !== null) {
            return $model;
        } else {
