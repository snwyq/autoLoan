...
use backend\models\search\ProductMoneyChannelProductSearch;
...
/**
 * ProductMoneyChannelProductController implements the CRUD actions for ProductMoneyChannelProduct model.
 */
class ProductMoneyChannelProductController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\ProductMoneyChannelProduct',
                        'searchModelClass' => 'backend\models\search\ProductMoneyChannelProductSearch'            ],
            'access' => [
    ...
    /**
     * Finds the ProductMoneyChannelProduct model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ProductMoneyChannelProduct the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = ProductMoneyChannelProduct::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    {
    return new ProductMoneyChannelProduct();
    }
