...
use backend\models\search\LoanCarAssessControlSearch;
...
/**
 * LoanCarAssessControlController implements the CRUD actions for LoanCarAssessControl model.
 */
class LoanCarAssessControlController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\LoanCarAssessControl',
                        'searchModelClass' => 'backend\models\search\LoanCarAssessControlSearch'            ],
            'access' => [
    ...
    /**
     * Finds the LoanCarAssessControl model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return LoanCarAssessControl the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = LoanCarAssessControl::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    {
    return new LoanCarAssessControl();
    }
