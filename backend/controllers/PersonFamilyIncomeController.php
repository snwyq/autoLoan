...
use backend\models\search\PersonFamilyIncomeSearch;
...
/**
 * PersonFamilyIncomeController implements the CRUD actions for PersonFamilyIncome model.
 */
class PersonFamilyIncomeController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\PersonFamilyIncome',
                        'searchModelClass' => 'backend\models\search\PersonFamilyIncomeSearch'            ],
            'access' => [
...
//            ],
    ...
    {
        return $this->module->getViewPath() . DIRECTORY_SEPARATOR . 'customer/person-family-income';
    }
    ...
    public function actionCreate($id)
    {
        ...
        $model = new PersonFamilyIncome();
        $model->customer_id = $id;

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->setFlash('success', Yii::t('backend', '增加成功！'));
            return $this->redirect(['customer/family-income-list', 'id' =>$id]);
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->redirect(['customer/family-income-list', 'id' =>$customer_id]);
        }
    ...
    /**
     * Finds the PersonFamilyIncome model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return PersonFamilyIncome the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = PersonFamilyIncome::findOne($id)) !== null) {
            return $model;
        } else {
