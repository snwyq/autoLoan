...
use backend\models\search\CompanyOtherLoanSearch;
...
/**
 * CompanyOtherLoanController implements the CRUD actions for CompanyOtherLoan model.
 */
class CompanyOtherLoanController extends Controller
{
    public function behaviors()
    {
        return [
            'model' => [
                        ...
                        'modelClass' => 'common\models\CompanyOtherLoan',
                        'searchModelClass' => 'backend\models\search\CompanyOtherLoanSearch'            ],
            'access' => [
...
//            ],
    ...
    {
        return $this->module->getViewPath() . DIRECTORY_SEPARATOR . 'customer/company-other-loan';
    }
    ...
    public function actionCreate($id)
    {
        ...
        $model = new CompanyOtherLoan();
        $model->customer_id = $id;

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->setFlash('success', Yii::t('backend', '增加成功！'));
            return $this->redirect(['customer/other-loan-list', 'id' =>$id]);
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->redirect(['customer/other-loan-list', 'id' =>$customer_id]);
        }
    ...
    /**
     * Finds the CompanyOtherLoan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CompanyOtherLoan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function findModel($id)
    {
        if (($model = CompanyOtherLoan::findOne($id)) !== null) {
            return $model;
        } else {
