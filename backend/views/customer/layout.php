        ...
        <div class="box box-solid">
            <div class="box-body no-padding">
                <?= Nav::widget([
                    ...
                    'items' => [
                        ['label' => '<i class="fa fa-user"></i> '. Yii::t('app', 'Account details'), 'url' => ['/customer/update', 'id' => $customer->id], 'encode' => false],
                        ['label' => '<i class="fa fa-user"></i> '. Yii::t('app', '客户详情'), 'url' => ['/customer/customer-profile', 'id' => $customer->id], 'encode' => false],
                        ...
                        ['label' => '<i class="fa fa-user"></i> '. Yii::t('app', '家庭支出'), 'url' => ['/customer/faily-pay-list', 'id' => $customer->id], 'encode' => false],
                        ['label' => '<i class="fa fa-user"></i> '. Yii::t('app', '收款帐号'), 'url' => ['/customer/bankcard-list', 'id' => $customer->id], 'encode' => false],
