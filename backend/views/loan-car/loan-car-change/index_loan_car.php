...
$this->title = Yii::t('app', '车辆置换----监管车辆列表');
...
<div class="box box-primary">
    ...
    <div class="box-body"><?php echo $this->render('_search_loan_car', ['model' => $searchModel]); ?></div>
</div>
...
//                'car_series_id',
               ...
               //  'status:text:状态',
                ...
                [
                    ...
                    'attribute' => '操作',
                    'value' => function ($model) {
                        return  Html::a('置换申请',['loan-car-change/create','id'=>$model->id]);
                    },
                    'format' => 'raw',
